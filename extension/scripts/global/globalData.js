...
const DEFAULT_STORAGE = {
	...
	settings: {
		...
		customTheming: {
			enabled: new DefaultSetting({ type: "boolean", defaultValue: false }),
			backgroundImage: new DefaultSetting({ type: "string", defaultValue: "" }),
			backgroundColor: new DefaultSetting({ type: "string", defaultValue: "" }),
			backgroundOpacity: new DefaultSetting({ type: "number", defaultValue: 0.1 }),
			backgroundSize: new DefaultSetting({ type: "string", defaultValue: "cover" }),
